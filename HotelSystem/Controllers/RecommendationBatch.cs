...
namespace HotelSystem.Controllers
{
    public class RecommendationBatch
    {
        ...
        public static void SaveBlobToFile(AzureBlobDataReference blobLocation, string resultsLabel,string userid)
        {
            String pth = System.Web.HttpContext.Current.Server.MapPath("~");
            pth += "/Content/";
            string OutputFileLocation = pth+ "output1results" + userid + ".csv"; // Replace this with the location you would like to use for your output file
        ...
        public static string ProcessResults(BatchScoreStatus status,string userid)
        {
            ...
            foreach (var output in status.Results)
            {
                ...
                {
                    first = false;
                    SaveBlobToFile(blobLocation, string.Format("The results for {0}", output.Key),userid);
                }
            }
            return status.Results.ToString();
        }

        public static string InvokeBatchExecutionService(string userid)
        {
            try
            {
                // How this works:
                ...
                const int TimeOutInMilliseconds = 600 * 1000; // Set a timeout of 2 minutes
                ...
                String pth = System.Web.HttpContext.Current.Server.MapPath("~");
                pth += "/Content/";
                UploadFileToBlob(pth + "SingleUser" + userid + ".csv" /*Replace this with the location of your input file*/,
                   "SingleUserBlob" + userid + ".csv" /*Replace this with the name you would like to use for your Azure blob; this needs to have the same extension as the input file */,
                ...
                using (HttpClient client = new HttpClient())
                {
                        ...
                        Inputs = new Dictionary<string, AzureBlobDataReference>()
                    {

                        {
                            ...
                            new AzureBlobDataReference()
                            {
                                ...
                                RelativeLocation = string.Format("{0}/"+"SingleUserBlob" + userid + ".csv", StorageContainerName)
                            }
                        },
                    },
                        ...
                        Outputs = new Dictionary<string, AzureBlobDataReference>()
                    {

                        {
                            ...
                            {
                                ConnectionString = storageConnectionString,
                                RelativeLocation = string.Format("/{0}/output1results"+userid+".csv", StorageContainerName)
                            }
                        },
                    },
                    ...
                    while (!done)
                    {
                        ...
                        switch (status.StatusCode)
                        {
                            ...
                            case BatchScoreStatusCode.Finished:
                                ...
                                return ProcessResults(status, userid);
